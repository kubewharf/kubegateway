module github.com/kubewharf/apiserver-runtime
...
require (
	...
	k8s.io/cluster-bootstrap v0.18.10 // indirect
...
replace (
	...
	k8s.io/apiserver => github.com/kubewharf/apiserver v0.0.0-20220718061532-19e8d93c2c98
